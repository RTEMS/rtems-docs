...
Before submitting a patch, please read [Commit Message Guidance] to
...
For public repositories, you may like to try [GitHub](https://github.com/)
or [BitBucket](https://bitbucket.org/). RTEMS maintains
[mirrors on GitHub](https://github.com/RTEMS) which can make synchronizing
...
instructions](https://git-scm.com/book/en/v2/Git-on-the-Server-Setting-Up-the-Server) on
