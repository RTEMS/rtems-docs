...
By default, this configuration parameter defines also the minimum stack size of
...
The stack checker performs run-time stack bounds checking. This increases the
