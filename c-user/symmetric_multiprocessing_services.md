...
documented in the [libgomp manual](https://gcc.gnu.org/onlinedocs/libgomp/).
...
the standard C [\<stdatomic.h>](https://en.cppreference.com/w/c/atomic) or C++
[\<atomic>](https://en.cppreference.com/w/cpp/atomic/atomic) APIs in
applications.
...
of cache lines can be observed with the [TMFINE 1](https://gitlab.rtems.org/rtems/rtos/rtems/-/blob/main/testsuites/tmtests/tmfine01) test program
...
The test program [SMPLOCK 1](https://gitlab.rtems.org/rtems/rtos/rtems/-/blob/main/testsuites/smptests/smplock01) can be used
...
2. For low level support libraries an API for statically allocated
   ...
   [\<rtems/score/percpudata.h>](https://gitlab.rtems.org/rtems/rtos/rtems/-/blob/main/cpukit/include/rtems/score/percpudata.h).
