...
- [CAN virtual driver](https://gitlab.rtems.org/rtems/rtos/rtems/-/blob/main/cpukit/dev/can/can-virtual.c)
- [CTU CAN FD driver](https://gitlab.rtems.org/rtems/rtos/rtems/-/blob/main/cpukit/dev/can/ctucanfd/ctucanfd.c)
