...
[bsps/shared/start/bspfatal-default.c](https://gitlab.rtems.org/rtems/rtos/rtems/-/blob/main/bsps/shared/start/bspfatal-default.c)
file.
...
`RTEMS_PROFILING` being set to True. A BSP may provide data for the
interrupt delay times. The BSP can feed interrupt delay times with the
...
[\<bsp/irq-generic.h>](https://gitlab.rtems.org/rtems/rtos/rtems/-/blob/main/bsps/include/bsp/irq-generic.h)
and
[\<bsp/irq-info.h>](https://gitlab.rtems.org/rtems/rtos/rtems/-/blob/main/bsps/include/bsp/irq-info.h)
