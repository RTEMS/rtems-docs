...
- An optional [timecounter](http://www.freebsd.dk/pubs/timecounter.pdf) to
...
[clockimpl.h](https://gitlab.rtems.org/rtems/rtos/rtems/-/blob/main/bsps/shared/dev/clock/clockimpl.h)
...
For an example see the [QorIQ clock driver](https://gitlab.rtems.org/rtems/rtos/rtems/-/blob/main/bsps/powerpc/qoriq/clock/clock-config.c).
...
For an example see the [ERC32 clock driver](https://gitlab.rtems.org/rtems/rtos/rtems/-/blob/main/bsps/sparc/erc32/clock/ckinit.c).
...
For an example see the [Motrola 68360 clock driver](https://gitlab.rtems.org/rtems/rtos/rtems/-/blob/main/bsps/m68k/gen68360/clock/clock.c).
