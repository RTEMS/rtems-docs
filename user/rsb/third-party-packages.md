...
1. The tools, RTEMS kernel and any dependent libraries such as LibBSD. The
...
2. The RTEMS kernel and any dependent libraries such as LibBSD. The tools path
...
3. The path the package is installed into. The tools path needs to be in the
